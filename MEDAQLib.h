...
typedef enum
	...
	CONTROLLER_KSB6430=  75, // combiSENSOR, only for SensorFinder functionality, OpenSensor will fail
	...
	IE_IF203x=           74, // Interface module Industrial Ethernet, only for SensorFinder functionality, OpenSensor will fail
...
/* SetParameter
   ...
   Returns ERR_NOERROR on success, otherwise an error return value.          */
	...
	MEDAQLIB_API ERR_CODE WINAPI SetParameterStringL    (uint32_t instanceHandle, const char *paramName, const char *   paramValue, uint32_t len);
